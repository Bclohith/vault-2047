        ...
        <div className="w-full bg-gray-950 flex flex-col items-center justify-start px-6 lg:px-28 py-16 gap-12 overflow-hidden">
          ...
          <div className="w-full max-w-[1200px] flex flex-col items-start gap-12">
            ...
            <div className="w-full flex flex-col items-start gap-8">
              ...
              <div className="w-full md:w-auto flex flex-col sm:flex-row justify-start items-center gap-3">
              ...
              <div className="w-full flex flex-row justify-start items-center gap-4 md:gap-6 flex-wrap">
...
fs.writeFileSync('src/app/knowledge-hub/page.js', content);
console.log('Successfully updated src/app/knowledge-hub/page.js');
