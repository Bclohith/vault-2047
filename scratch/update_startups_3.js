      ...
      <main className="flex-grow flex flex-col items-center justify-start pt-20 md:pt-24">
          ...
          <div className="w-full lg:w-[500px] h-[300px] md:h-[384px] relative overflow-hidden shrink-0 group">
            ...
            <div className="absolute top-0 left-0 h-full flex w-[200%] animate-scroll-horizontal group-hover:[animation-play-state:paused]">
              ...
              <div className="w-1/2 h-full flex items-center justify-around gap-4 px-2">
                <div className="w-[300px] h-full relative p-2.5 shrink-0">
                  <Image src="/assets/startups/b0399b8c6a2c0283c13cb9d1e72a132fb44eb0be (1).png" alt="Startup 1" fill className="object-cover rounded-md" />
                </div>
                <div className="w-[300px] h-full relative p-2.5 shrink-0">
                  <Image src="/assets/startups/ad7d37b9a55dce7f2273634de8f7755ebb7b3047 (1).png" alt="Startup 2" fill className="object-cover rounded-md" />
                </div>
                <div className="w-[300px] h-full relative p-2.5 shrink-0">
                  <Image src="/assets/startups/c68bdeb40527b99c0ccc8aca218963b26b9f3b11 (1).png" alt="Startup 3" fill className="object-cover rounded-md" />
                </div>
                <div className="w-[300px] h-full relative p-2.5 shrink-0">
                  <Image src="/assets/startups/a3f4ea6c4aaa8ed0da82a97c1c6b636cdea78593 (1).png" alt="Startup 4" fill className="object-cover rounded-md" />
                </div>
              </div>
        ...
        <div className="w-full px-6 lg:px-28 py-16 md:py-24 bg-neutral-900 flex flex-col justify-center items-center gap-12 overflow-hidden">
          ...
          <div className="w-full max-w-[1200px] grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div className="w-full bg-white/5 outline outline-1 outline-offset-[-0.50px] outline-amber-700/30 flex flex-col justify-start items-start gap-4 overflow-hidden group hover:outline-amber-700/70 transition-all">
        ...
        <div className="w-full px-6 lg:px-28 py-16 md:py-24 bg-gray-950 flex flex-col justify-center items-center overflow-hidden">
            ...
            <div className="w-full flex flex-col lg:flex-row justify-start items-stretch gap-12">
              ...
              <div className="w-full lg:w-[500px] h-[300px] md:h-[400px] lg:h-auto relative overflow-hidden shrink-0 group">
                ...
                <div className="absolute top-0 right-0 h-full flex w-[200%] animate-scroll-horizontal-reverse group-hover:[animation-play-state:paused]">
                  ...
                  <div className="w-1/2 h-full flex items-center justify-around gap-4 px-2">
                    <div className="w-[300px] h-full relative p-2.5 shrink-0">
                      <Image src="/assets/startups/e4d29a2fddbeaff0dbf51fd9f2c68d5e741e0c01 (1).png" alt="Experience 1" fill className="object-cover rounded-md" />
                    </div>
                    <div className="w-[300px] h-full relative p-2.5 shrink-0">
                      <Image src="/assets/startups/26ad5c312b6e579ed96b82387d71ce49546e1096 (1).png" alt="Experience 2" fill className="object-cover rounded-md" />
                    </div>
                    <div className="w-[300px] h-full relative p-2.5 shrink-0">
                      <Image src="/assets/startups/3227a945a7998f7cefd92006eec8bb3785ce434f (1).png" alt="Experience 3" fill className="object-cover rounded-md" />
                    </div>
                  </div>
