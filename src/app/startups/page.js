  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#040b0e]">
      ...
      <main className="flex-grow flex flex-col items-center justify-start pt-20 md:pt-24">
        ...
        {/* The Complete Startup Experience Section (Moved up) */}
        ...
        {/* Explore a Host of Opportunities Section (Moved down to last) */}
          ...
          <div className="w-full max-w-[1100px] grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="w-full h-auto min-h-[400px] md:h-[509px] p-8 relative bg-gradient-to-b from-black/0 to-stone-950/0 outline outline-1 outline-offset-[-0.50px] outline-[#B86A2E]/30 flex flex-col justify-between items-start overflow-hidden group hover:outline-[#B86A2E] hover:-translate-y-2 transition-all duration-300">
              ...
              <div className="w-full h-36 flex flex-col justify-end items-start gap-3 relative z-10">
                <div className="text-white text-2xl font-bold font-['Orbitron'] group-hover:text-[#B86A2E] transition-colors leading-tight uppercase">THE CYBER FOUNDRY</div>
              ...
              <div className="w-16 h-20 left-[24px] top-[299px] absolute origin-top-left -rotate-90 opacity-50 bg-[#B86A2E]/20 group-hover:bg-[#B86A2E]/40 transition-colors pointer-events-none" />
              <div className="w-16 h-20 left-[58px] top-[266px] absolute origin-top-left -rotate-90 opacity-50 bg-[#B86A2E]/20 group-hover:bg-[#B86A2E]/40 transition-colors pointer-events-none" />
            </div>
            ...
            <div className="w-full h-auto min-h-[400px] md:h-[509px] p-8 relative bg-gradient-to-b from-black/0 to-stone-950/0 outline outline-1 outline-offset-[-0.50px] outline-[#B86A2E]/30 flex flex-col justify-between items-start overflow-hidden group hover:outline-[#B86A2E] hover:-translate-y-2 transition-all duration-300">
              ...
              <div className="w-full h-36 flex flex-col justify-end items-start gap-3 relative z-10">
                <div className="text-white text-2xl font-bold font-['Orbitron'] group-hover:text-[#B86A2E] transition-colors leading-tight uppercase">GLOBAL INVESTOR ACCESS</div>
              </div>
            ...
            <div className="w-full h-auto min-h-[400px] md:h-[509px] p-8 relative bg-gradient-to-b from-black/0 to-stone-950/0 outline outline-1 outline-offset-[-0.50px] outline-[#B86A2E]/30 flex flex-col justify-between items-start overflow-hidden group hover:outline-[#B86A2E] hover:-translate-y-2 transition-all duration-300">
              ...
              <div className="w-full h-36 flex flex-col justify-end items-start gap-3 relative z-10">
                <div className="text-white text-2xl font-bold font-['Orbitron'] group-hover:text-[#B86A2E] transition-colors leading-tight uppercase">STARTUP INNOVATION ZONE</div>
